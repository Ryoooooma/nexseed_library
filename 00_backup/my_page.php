...
<head>
    ...
    <link rel="shortcut icon" href="my_page/favicon.ico">  
    <link href='http://fonts.googleapis.com/css?family=Lato:300,400,300italic,400italic' rel='stylesheet' type='text/css'>
    <link href='http://fonts.googleapis.com/css?family=Montserrat:400,700' rel='stylesheet' type='text/css'> 
    <!-- Global CSS -->
    <link rel="stylesheet" href="my_page/assets/plugins/bootstrap/css/bootstrap.min.css">   
    <!-- Plugins CSS -->
    <link rel="stylesheet" href="my_page/assets/plugins/font-awesome/css/font-awesome.css">
    <!-- github acitivity css -->
    <link rel="stylesheet" href="my_page/assets/plugins/github-activity/dist/github-activity-0.1.1.min.css">
    <link rel="stylesheet" href="my_page/assets/plugins/github-activity/dist/octicons/octicons.min.css">
    
    
    <!-- Theme CSS -->  
    <link id="theme-style" rel="stylesheet" href="my_page/assets/css/styles.css">
...
<body>
    ...
    <header class="header">
        <div class="container">                       
            <img class="profile-image img-responsive pull-left" src="my_page/assets/images/profile.png" alt="James Lee" />
                        ...
                        <div class="content">    
                            ...
                            <div class="item featured text-center">
                                ...
                                <div class="featured-image">
                                    ...
                                    <img class="img-responsive project-image" src="my_page/assets/images/projects/project-featured.png" alt="project name" />
                                    </a>
                                    <div class="ribbon">
                            ...
                            <div class="item row">
                                ...
                                <img class="img-responsive project-image" src="my_page/assets/images/projects/project-5.png" alt="project name" />
                                </a>
                            ...
                            <div class="item row">
                                ...
                                <img class="img-responsive project-image" src="my_page/assets/images/projects/project-4.png" alt="project name" />
                                </a>
                                <div class="desc col-md-8 col-sm-8 col-xs-12">
                            ...
                            <div class="item row">
                                ...
                                <img class="img-responsive project-image" src="my_page/assets/images/projects/project-1.png" alt="project name" />
                                </a>
                                <div class="desc col-md-8 col-sm-8 col-xs-12">
                            ...
                            <div class="item row">
                                ...
                                <img class="img-responsive project-image" src="my_page/assets/images/projects/project-2.png" alt="project name" />
                                </a>
                                <div class="desc col-md-8 col-sm-8 col-xs-12">
    ...
    <!-- Javascript -->          
    <script type="text/javascript" src="my_page/assets/plugins/jquery-1.11.2.min.js"></script>
    <script type="text/javascript" src="my_page/assets/plugins/jquery-migrate-1.2.1.min.js"></script>
    <script type="text/javascript" src="my_page/assets/plugins/bootstrap/js/bootstrap.min.js"></script>    
    <script type="text/javascript" src="my_page/assets/plugins/jquery-rss/dist/jquery.rss.min.js"></script> 
    <!-- github activity plugin -->
    <script type="text/javascript" src="my_page/assets/plugins/github-activity/dist/mustache/mustache.min.js"></script>
    <script type="text/javascript" src="my_page/assets/plugins/github-activity/dist/github-activity-0.1.1.min.js"></script>
    <!-- custom js -->
    <script type="text/javascript" src="my_page/assets/js/main.js"></script>            
</body>
</html> 
